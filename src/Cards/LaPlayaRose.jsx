...
// CSS
import styles from '../Cards/LaPlayaRose.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img className={styles.bottle} src={process.env.PUBLIC_URL + '/imgs/skus/laplaya_rose.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>La Playa Estate Series Dry Rose</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>A bang for your buck, and your health! This rose is a sleeper, best enjoyed on hot days with the sun held high. La Playa wines are produced with a focus on responsible viticulture and environmental stewardship.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Grilled fish<br />Bell peppers<br />Goat cheese</h5>
                                    </div>
