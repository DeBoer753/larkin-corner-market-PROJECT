...
// CSS
import styles from '../Cards/MaggioGrigio.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/maggio_grigio.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Maggio Pinot Grigio</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Maggio pinot grigio offers a delightful experience with its crisp and refreshing taste profile. The wine greets your palate with vibrant notes of green apple, citrus, and pear, creating a harmonious blend of flavors.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Chicken soup<br />Sauteed mushrooms<br />Cured meats</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold / Light<br />Dry<br />Soft</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
