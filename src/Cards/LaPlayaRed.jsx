...
// CSS
import styles from '../Cards/LaPlayaRed.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Steak / Sausages<br />Citrus salad<br />Gouda cheese</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Smooth<br />Sweet / Dry<br />Medium bodied</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
