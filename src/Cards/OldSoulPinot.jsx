...
// CSS
import styles from '../Cards/OldSoulPinot.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/oldsoul_pinot.png'} alt="" />
                            
                            <div className={styles.cardBottomHalf}>
                                <h5 className={styles.ofAge}>• Must be 21 years or older to purchase •</h5>
                                <h3>Old Soul Pinot Noir</h3>
                                <p className={styles.description}>Description</p>
                                <p className={styles.skuDescription}>Old Soul Pinot Noir delivers a delightful tasting experience with its smooth and well-balanced profile. Whether you're pairing it with a meal or enjoying it on its own, Old Soul Pinot Noir captivates with its depth of flavor and elegant complexity.</p>
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Herbed chicken<br />Butternut squash<br />Dark chocolate</h5>
                                    </div>
