...
// CSS
import styles from '../Cards/ThreadcountSB.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img className={styles.bottle} src={process.env.PUBLIC_URL + '/imgs/skus/threadcount_sb.png'} alt="" />
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Crab cakes / Fish<br />Nicoise salad<br />Blue cheese</h5>
                                    </div>
                                    <div className={styles.miniBox2}>
                                        <h4>Origin</h4>
                                        <hr />
                                        <h5 className={styles.origin}>California</h5>
                                    </div>
