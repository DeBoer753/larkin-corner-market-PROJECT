...
// CSS
import styles from '../Cards/QuiltCab.module.css'; // Make sure to create a CSS file (e.g., FlipCard.css) for styling
                ...
                <div className={styles.flipCardInner}>
                    ...
                    <div className={styles.flipCardFront}>
                        <div className={styles.innerElement}>
                            ...
                            <img src={process.env.PUBLIC_URL + '/imgs/skus/quilt_cab.png'} alt="" />
                            ...
                            <div className={styles.cardBottomHalf}>
                                ...
                                <div className={styles.miniBoxContainer}>
                                    <div className={styles.miniBox1}>
                                        <h4>Pairing</h4> 
                                        <hr />
                                        <h5 className={styles.pairing}>Beef kebabs<br />Eggplant parmesan<br /> Aged cheddar</h5>
                                    </div>
                                    ...
                                    <div className={styles.miniBox3}>
                                        <h4>Taste</h4>
                                        <hr />
                                        <h5 className={styles.taste}>Bold<br />Smooth / Tannic<br />Dry</h5>
                                    </div>
                                </div>
                            </div>
                        </div>  
